...
def render_movie_card(movie_row, reason=""):
...
def render_movie_card_with_actions(movie_row, reason="", key_prefix="", on_play=None, on_like=None, on_dislike=None):
    """Thẻ phim đầy đủ: poster + hover tooltip + 3 nút Play/Like/Dislike"""
    render_movie_card(movie_row, reason=reason)
